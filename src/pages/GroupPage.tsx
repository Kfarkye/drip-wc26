    ...
    return (
        <Layout>
            ...
            <section className="mb-20">
                <h2 className="text-2xl font-sans font-normal mb-8 text-ivory flex items-center gap-4">
                    <span className="h-[1px] w-8 bg-emerald/40" />
                    Group D Overview
                </h2>
                <p className="text-lg text-silver leading-relaxed mb-12 max-w-4xl italic font-serif">
            ...
            <section className="mb-20">
                ...
                <p className="text-lg text-silver leading-relaxed max-w-4xl italic font-serif">
            ...
            <section className="mb-20 border-t border-white/[0.05] pt-16">
                <h2 className="text-xl font-sans font-light mb-12 text-silver uppercase tracking-[0.2em]">Frequently Asked Questions</h2>
                <div className="grid md:grid-cols-2 gap-x-12 gap-y-16">
                    {faqs.map((faq, i) => (
                        <div key={i} className="group">
                            <h3 className="text-white font-medium mb-4 group-hover:text-emerald transition-colors">{faq.question}</h3>
                            <p className="text-silver text-sm leading-relaxed">{faq.answer}</p>
                        </div>
                    ))}
                </div>
            </section>
